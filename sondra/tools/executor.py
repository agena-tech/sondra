...
if os.getenv("SONDRA_SANDBOX_MODE", "false").lower() == "false":
...
_SERVER_TIMEOUT = float(Config.get("sondra_sandbox_execution_timeout") or "120")
SANDBOX_EXECUTION_TIMEOUT = _SERVER_TIMEOUT + 30
SANDBOX_CONNECT_TIMEOUT = float(Config.get("sondra_sandbox_connect_timeout") or "10")
