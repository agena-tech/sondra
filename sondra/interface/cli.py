...
async def run_cli(args: Any) -> None:  # noqa: PLR0915
    ...
    start_text = Text()
    start_text.append("Session initiated", style="bold #22c55e")
    ...
    results_text.append("  ")
    results_text.append(f"sondra_runs/{args.run_name}", style="#60a5fa")
    ...
    def create_live_status() -> Panel:
        status_text = Text()
        status_text.append("Session in progress", style="bold #22c55e")
        status_text.append("\n\n")
    ...
    try:
        ...
        with Live(
            ...
            try:
                ...
                if isinstance(result, dict) and not result.get("success", True):
                    ...
                    console.print()
                    console.print(f"[bold red]Session failed:[/] {error_msg}")
                    if error_details:
        ...
        console.print(f"[bold red]Error during session:[/] {e}")
        raise
    ...
    if tracer.final_scan_result:
        ...
        final_report_text.append("Session summary", style="bold #60a5fa")
