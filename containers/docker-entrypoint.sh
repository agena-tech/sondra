...
export SONDRA_SANDBOX_MODE=true
export POETRY_VIRTUALENVS_CREATE=false
export TOOL_SERVER_TIMEOUT="${SONDRA_SANDBOX_EXECUTION_TIMEOUT:-120}"
export TOOL_SERVER_MODULE="${SONDRA_TOOL_SERVER_MODULE:-sondra.runtime.tool_server}"
TOOL_SERVER_LOG="/tmp/tool_server.log"

echo "Using tool server module: ${TOOL_SERVER_MODULE}"

sudo -E -u pentester \
  poetry run python -m "$TOOL_SERVER_MODULE" \
